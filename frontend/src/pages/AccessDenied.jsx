        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          {user && (
            <div className="bg-slate-800/50 rounded-lg p-4 mb-6">
              <p className="text-xs text-slate-500 uppercase tracking-wider mb-2">Account Information</p>
              <div className="space-y-1">
                ...
                {user.groups && user.groups.length > 0 && (
                  <p className="text-sm text-slate-300">
                    <span className="text-slate-500">Groups:</span> {user.groups.join(', ')}
                  </p>
                )}
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <a
              href="/"
              className="w-full flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-300 font-medium py-3 px-4 rounded-xl transition-colors"
            >
              Return to Home
            </a>
          </div>

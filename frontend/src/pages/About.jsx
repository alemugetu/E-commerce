  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200 hover:shadow-lg transition-shadow">
            ...
            <h3 className="font-semibold text-slate-900 mb-2">Trust & Integrity</h3>
            <p className="text-sm text-slate-600">
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200 hover:shadow-lg transition-shadow">
            ...
            <h3 className="font-semibold text-slate-900 mb-2">Community Focus</h3>
            <p className="text-sm text-slate-600">
      ...
      <div className="text-center mt-16">
        <h2 className="text-2xl font-bold text-slate-900 mb-4">Ready to Start Shopping?</h2>

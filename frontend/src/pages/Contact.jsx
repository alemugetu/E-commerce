...
const Contact = () => {
  ...
  // Dynamic contact information from the store settings API
  const { settings, loading: settingsLoading } = useStoreSettingsContext();
  ...
  const handleSubmit = async (e) => {
    ...
    // TODO: Replace with real contact/inquiry API endpoint when available
    setTimeout(() => {
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200">
            ...
            {settingsLoading ? (
              ...
              <div className="space-y-4">
                {/* Email — only shown when configured */}
                {companyEmail && (
                ...
                {/* Phone — only shown when configured */}
                {companyPhone && (
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                {/* Address — only shown when configured */}
                {companyAddress && (
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                {/* Business hours are static operational info — not stored in settings */}
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center flex-shrink-0">
